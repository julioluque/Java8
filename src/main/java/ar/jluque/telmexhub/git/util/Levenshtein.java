package ar.jluque.telmexhub.git.util;
...
public class Levenshtein {
	...
	/**
	 * Main entry point that can be used to test and demonstrate the values created
	 * for the distance between pairs of strings
	 * 
